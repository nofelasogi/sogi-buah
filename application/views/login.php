				...
				<div class="auth-box ">
					<div class="left">
						<div class="content" style="width:300px;">
							<div class="header">
								<div class="logo text-center"><img src="<?= base_url()?>assets/img/logo.PNG" alt="Klorofil Logo" width="300"></div>
								<p class="lead">Silahkan Masuk Di Akun Anda</p>
							</div>
					...
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Makan Buah agar selalu sehat</h1>
							<p>Dan berenergi</p>
						</div>
					</div>
